...
// /*                                                +#+#+#+#+#+   +#+           */
// /*   Created: 2024/05/30 11:01:40 by otuyishi          #+#    #+#             */
// /*   Updated: 2024/05/30 11:34:44 by otuyishi         ###   ########.fr       */
// /*                                                                            */
// /* ************************************************************************** */
...
// void	Config::openCurlyBracket(int &countCurlBrackets) {
// 	countCurlBrackets++;
// }

// void	Config::closedCurlyBracket(int &countCurlBrackets) {
// 	countCurlBrackets--;
// }

// void	Config::semiColon(std::vector<lexer_node>::iterator it) {
// 	(void)it;
// }
...
// 	// std::map<int, void(*)()> locationContents;
// 	// locationContents[METHODS] = parseMethods;
// 	// locationContents[REDIRECT] = parseRedirect;
// 	// locationContents[ROOT] = parseLocationRoot;
// 	// locationContents[SEMICOLON] = semiColon;
// 	// locationContents[OPEN_CURLY_BRACKET] = openCurlyBracket;
// 	// locationContents[CLOSED_CURLY_BRACKET] = closedCurlyBracket;
// 	while (it != lexer.end()) {
// 		switch (it->type)
// 		{
// 		case (METHODS):
